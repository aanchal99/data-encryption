...
table1      db 97 dup (' '), 'klmnxyzabcopqrstvuwdfeghij'
table2      db 97 dup (' '), 'hijtvuwxyzabcdklmnoprqsefg'

msg1        DB  'Enter the string: ', '$'
msg2        DB  'Encrypted string: ', '$'
msg3        DB  'Decrypted string: ', '$'
...
;table1:    'klmnxyzabcopqrstvuwdfeghij'
;table2:    'hijtvuwxyzabcdklmnoprqsefg'
